	...
	if (modules.First().ToString() == "MCC-Win64-Shipping.exe")
	{
		...
		if (version == "1.2904.0.0")
		{
			...
			vars.watchers_slow = new MemoryWatcherList() {
				...
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x03F7BA50, 0xA8, 0xABD8E3), 4)), 
			...
			vars.watchers_h1 = new MemoryWatcherList() {
				...
				(vars.H1_tickcounter = new MemoryWatcher<uint>(new DeepPointer(0x03F7BA50, 0x8, 0x2B88848)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	//take the one near camera angle that flicks to FF FF FF FF on mission restart plz burnt :)
				...
				//(vars.H1_playerfrozen = new MemoryWatcher<bool>(new DeepPointer(0x03F7BA50, 0x8, 0x2E12600)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
			...
			vars.watchers_h2 = new MemoryWatcherList() {
				...
				(vars.H2_cutsceneflag = new MemoryWatcher<byte>(new DeepPointer(0x03F7BA50, 0x28, 0x14CFAE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_CSind = new MemoryWatcher<byte>(new DeepPointer(0x03F7BA50, 0x28, 0x01D37C20, 0x38, 0x78, 0x1E8, 0xE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
			...
			vars.watchers_h3IL = new MemoryWatcherList() {
				(vars.H3_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03F7BA50, 0x48, 0x9AD720)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			...
			vars.watchers_hr = new MemoryWatcherList() {
				(vars.HR_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03F7BA50, 0xC8, 0x023CC768, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03F7BA50, 0xC8, 0x00EF2010, 0x12E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			...
			vars.watchers_odst = new MemoryWatcherList() {
				(vars.odst_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03F7BA50, 0xA8, 0xA11C20)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			...
			vars.watchers_h4 = new MemoryWatcherList() {
				...
				(vars.H4_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03F7BA50, 0x68, 0x29A383E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
		...
		} else if (version == "1.2862.0.0")
		{
			vars.watchers_fast = new MemoryWatcherList() {
				(vars.menuindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E455A9)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //behaviour changed to 07 and 0B, instead of 07 and 0C
				(vars.stateindicator = new MemoryWatcher<byte>(new DeepPointer(0x3F2FC49)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_slow = new MemoryWatcherList() {
				(vars.gameindicator = new MemoryWatcher<byte>(new DeepPointer(0x03F7C410, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //scan for 8B 4B 18 ** ** ** ** **    48 8B 5C 24 30  89 07 nonwriteable, check what 89 07 writes to
				(vars.H2_levelname = new StringWatcher(new DeepPointer(0x03F7BAD0, 0x28, 0xD4ABF8), 3)),
				(vars.H3_levelname = new StringWatcher(new DeepPointer(0x03F7BAD0, 0x48, 0x1E092E8), 3)), 
				(vars.HR_levelname = new StringWatcher(new DeepPointer(0x03F7BAD0, 0xC8, 0x290BDA7), 3)),
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x03F7BAD0, 0xA8, 0xABD8E3), 4)), 
				(vars.ODST_levelnameBad2 = new StringWatcher(new DeepPointer(0x03F7BAD0, 0xA8, 0x20872f5), 4)), 
			...
			vars.watchers_h1death = new MemoryWatcherList(){
				(vars.H1_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03F7BAD0, 0x8, 0x2B611B7)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			//scan for 00 00 80 3F 00 00 80 3F 00 00 80 3F 02 00 00 00 FF FF 00 during cryo cs. Last 7 values are these, in order.
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x03F7BAD0, 0x8, 0x2E7F878, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x03F7BAD0, 0x8, 0x2E7F878, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03F7BAD0, 0x8, 0x2E7F878, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			...
			vars.watchers_h2bsp = new MemoryWatcherList() {
				(vars.H2_bspstate = new MemoryWatcher<byte>(new DeepPointer(0x03F7BAD0, 0x28, 0xCACD74)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2xy = new MemoryWatcherList() {
				(vars.H2_xpos = new MemoryWatcher<float>(new DeepPointer(0x03F7BAD0, 0x28, 0xD5A148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_ypos = new MemoryWatcher<float>(new DeepPointer(0x03F7BAD0, 0x28, 0xD5A14C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			...
			vars.watchers_h2death = new MemoryWatcherList(){
				(vars.H2_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03F7BAD0, 0x28, 0x00D5A5A0, -0xEF)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_h3 = new MemoryWatcherList() {
				(vars.H3_theatertime = new MemoryWatcher<uint>(new DeepPointer(0x03F7BAD0, 0x48, 0x1EF61E8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
				//(vars.H3_validtimeflag = new MemoryWatcher<byte>(new DeepPointer(0x038CF520, 0x48, 0xD64296)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) //not using anymore
			};
			
			vars.watchers_h3bsp = new MemoryWatcherList() {
				(vars.H3_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03F7BAD0, 0x48, 0x99FCA0, 0x2C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3IL = new MemoryWatcherList() {
				(vars.H3_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03F7BAD0, 0x48, 0x9AD720)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3death = new MemoryWatcherList(){
				(vars.H3_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03F7BAD0, 0x48, 0x1D8DF48, 0x1073D)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H3_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hr = new MemoryWatcherList() {
				(vars.HR_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03F7BAD0, 0xC8, 0x023CC768, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03F7BAD0, 0xC8, 0x00EF2010, 0x12E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrbsp = new MemoryWatcherList() {
				(vars.HR_bspstate = new MemoryWatcher<uint>(new DeepPointer(0x03F7BAD0, 0xC8, 0x3719E24)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrdeath = new MemoryWatcherList(){
				(vars.HR_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03F7BAD0, 0xC8, 0x00EEF330, 0xEF2010)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_odst = new MemoryWatcherList() {
				(vars.odst_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03F7BAD0, 0xA8, 0xA11C20)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
				
			};
			
			vars.watchers_odstbsp = new MemoryWatcherList() {
				(vars.odst_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03F7BAD0, 0xA8, 0x2F9FD5C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			
			vars.watchers_odstdeath = new MemoryWatcherList(){
				(vars.odst_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03F7BAD0, 0xA8, 0x00F3EB8C, -0x913)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.odst_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			...
			vars.watchers_h4 = new MemoryWatcherList() {
				...
				(vars.H4_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03F7BAD0, 0x68, 0x29A383E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4bsp = new MemoryWatcherList() {
				(vars.H4_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03F7BAD0, 0x68, 0x25DC188)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			
			
			
		} else if (version == "1.2845.0.0")
		{
			vars.watchers_fast = new MemoryWatcherList() {
				(vars.menuindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E7BAA9)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //behaviour changed to 07 and 0B, instead of 07 and 0C
				(vars.stateindicator = new MemoryWatcher<byte>(new DeepPointer(0x3F66149)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_slow = new MemoryWatcherList() {
				(vars.gameindicator = new MemoryWatcher<byte>(new DeepPointer(0x03FB2910, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //scan for 8B 4B 18 ** ** ** ** **    48 8B 5C 24 30  89 07 nonwriteable, check what 89 07 writes to
				(vars.H2_levelname = new StringWatcher(new DeepPointer(0x003FB1FD0, 0x28, 0xD4ABF8), 3)),
				(vars.H3_levelname = new StringWatcher(new DeepPointer(0x003FB1FD0, 0x48, 0x1E092E8), 3)), 
				(vars.HR_levelname = new StringWatcher(new DeepPointer(0x003FB1FD0, 0xC8, 0x290BDA7), 3)),
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x003FB1FD0, 0xA8, 0xABD8E3), 4)), 
				(vars.ODST_levelnameBad2 = new StringWatcher(new DeepPointer(0x003FB1FD0, 0xA8, 0x20872f5), 4)), 
				
				(vars.H4_levelname = new StringWatcher(new DeepPointer(0x003FB1FD0, 0x68, 0x29A3743), 3))
			};
			...
			vars.watchers_h1xy = new MemoryWatcherList() {
				(vars.H1_xpos = new MemoryWatcher<float>(new DeepPointer(0x003FB1FD0, 0x8, 0x2D73144)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_ypos = new MemoryWatcher<float>(new DeepPointer(0x003FB1FD0, 0x8, 0x2D73148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h1death = new MemoryWatcherList(){
				(vars.H1_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x003FB1FD0, 0x8, 0x2B611B7)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			//scan for 00 00 80 3F 00 00 80 3F 00 00 80 3F 02 00 00 00 FF FF 00 during cryo cs. Last 7 values are these, in order.
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x003FB1FD0, 0x8, 0x2E7F878, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x003FB1FD0, 0x8, 0x2E7F878, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x003FB1FD0, 0x8, 0x2E7F878, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2 = new MemoryWatcherList() {
				(vars.H2_tickcounter = new MemoryWatcher<uint>(new DeepPointer(0x003FB1FD0, 0x28, 0x1776D04)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_cutsceneflag = new MemoryWatcher<byte>(new DeepPointer(0x003FB1FD0, 0x28, 0x14CFAE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_CSind = new MemoryWatcher<byte>(new DeepPointer(0x003FB1FD0, 0x28, 0x01D37C20, 0x38, 0x78, 0x1E8, 0xE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x003FB1FD0, 0x28, 0x01520498, -0x92E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_letterbox = new MemoryWatcher<float>(new DeepPointer(0x003FB1FD0, 0x28, 0x01520498, -0x938)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_graphics = new MemoryWatcher<byte>(new DeepPointer(0x003FB1FD0, 0x28, 0xCCF280)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) //scan for FF FF FF FF 2A 0A 00 0D on outskirts. Should be around here somewhere
			};
			
			vars.watchers_h2bsp = new MemoryWatcherList() {
				(vars.H2_bspstate = new MemoryWatcher<byte>(new DeepPointer(0x003FB1FD0, 0x28, 0xCACD74)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2xy = new MemoryWatcherList() {
				(vars.H2_xpos = new MemoryWatcher<float>(new DeepPointer(0x003FB1FD0, 0x28, 0xD5A148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_ypos = new MemoryWatcher<float>(new DeepPointer(0x003FB1FD0, 0x28, 0xD5A14C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2IL = new MemoryWatcherList() {
				(vars.H2_IGT = new MemoryWatcher<uint>(new DeepPointer(0x003FB1FD0, 0x28, 0x147D9F0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2death = new MemoryWatcherList(){
				(vars.H2_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x003FB1FD0, 0x28, 0x00D5A5A0, -0xEF)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_h3 = new MemoryWatcherList() {
				(vars.H3_theatertime = new MemoryWatcher<uint>(new DeepPointer(0x003FB1FD0, 0x48, 0x1EF61E8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
				//(vars.H3_validtimeflag = new MemoryWatcher<byte>(new DeepPointer(0x038CF520, 0x48, 0xD64296)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) //not using anymore
			};
			
			vars.watchers_h3bsp = new MemoryWatcherList() {
				(vars.H3_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x003FB1FD0, 0x48, 0x99FCA0, 0x2C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3IL = new MemoryWatcherList() {
				(vars.H3_IGT = new MemoryWatcher<uint>(new DeepPointer(0x003FB1FD0, 0x48, 0x9AD720)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3death = new MemoryWatcherList(){
				(vars.H3_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x003FB1FD0, 0x48, 0x1D8DF48, 0x1073D)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H3_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hr = new MemoryWatcherList() {
				(vars.HR_IGT = new MemoryWatcher<uint> (new DeepPointer(0x003FB1FD0, 0xC8, 0x023CC768, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x003FB1FD0, 0xC8, 0x00EF2010, 0x12E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrbsp = new MemoryWatcherList() {
				(vars.HR_bspstate = new MemoryWatcher<uint>(new DeepPointer(0x003FB1FD0, 0xC8, 0x3719E24)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrdeath = new MemoryWatcherList(){
				(vars.HR_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x003FB1FD0, 0xC8, 0x00EEF330, 0xEF2010)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_odst = new MemoryWatcherList() {
				(vars.odst_IGT = new MemoryWatcher<uint>(new DeepPointer(0x003FB1FD0, 0xA8, 0xA11C20)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
				
			};
			
			vars.watchers_odstbsp = new MemoryWatcherList() {
				(vars.odst_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x003FB1FD0, 0xA8, 0x2F9FD5C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			
			vars.watchers_odstdeath = new MemoryWatcherList(){
				(vars.odst_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x003FB1FD0, 0xA8, 0x00F3EB8C, -0x913)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.odst_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4 = new MemoryWatcherList() {
				(vars.H4_IGT = new MemoryWatcher<uint> (new DeepPointer(0x003FB1FD0, 0x68, 0x0267C478, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H4_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x003FB1FD0, 0x68, 0x29A383E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4bsp = new MemoryWatcherList() {
				(vars.H4_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x003FB1FD0, 0x68, 0x25DC188)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			
			
			
		} else if (version == "1.2835.0.0")
		{
			vars.watchers_fast = new MemoryWatcherList() {
				(vars.menuindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E7BAA9)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //behaviour changed to 07 and 0B, instead of 07 and 0C
				(vars.stateindicator = new MemoryWatcher<byte>(new DeepPointer(0x3F66149)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			...
			vars.watchers_h1 = new MemoryWatcherList() {
				...
				(vars.H1_cutsceneskip = new MemoryWatcher<bool>(new DeepPointer(0x003FB1FD0, 0x8, 0x02E773D8, 0x0B)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			...
			//scan for 00 00 80 3F 00 00 80 3F 00 00 80 3F 02 00 00 00 FF FF 00 during cryo cs. Last 7 values are these, in order.
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x003FB1FD0, 0x8, 0x2E7F868, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x003FB1FD0, 0x8, 0x2E7F868, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x003FB1FD0, 0x8, 0x2E7F868, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
		...
		} else if (version == "1.2819.0.0")
		{
			vars.watchers_fast = new MemoryWatcherList() {
				(vars.menuindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E7BBA9)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //behaviour changed to 07 and 0B, instead of 07 and 0C
				(vars.stateindicator = new MemoryWatcher<byte>(new DeepPointer(0x3F66249)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_slow = new MemoryWatcherList() {
				(vars.gameindicator = new MemoryWatcher<byte>(new DeepPointer(0x03FB2A10, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //scan for 8B 4B 18 ** ** ** ** **    48 8B 5C 24 30  89 07 nonwriteable, check what 89 07 writes to
				(vars.H2_levelname = new StringWatcher(new DeepPointer(0x03FB20D0, 0x28, 0xD4ABF8), 3)),
				(vars.H3_levelname = new StringWatcher(new DeepPointer(0x03FB20D0, 0x48, 0x1E09268), 3)), 
				(vars.HR_levelname = new StringWatcher(new DeepPointer(0x03FB20D0, 0xC8, 0x290BDA7), 3)),
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x03FB20D0, 0xA8, 0xABD8E3), 4)), 
				(vars.ODST_levelnameBad2 = new StringWatcher(new DeepPointer(0x03FB20D0, 0xA8, 0x20872f5), 4)), 
				
				(vars.H4_levelname = new StringWatcher(new DeepPointer(0x03FB20D0, 0x68, 0x29A3743), 3))
			};
			...
			vars.watchers_h1 = new MemoryWatcherList() {
				...
				(vars.H1_cutsceneskip = new MemoryWatcher<bool>(new DeepPointer(0x03FB20D0, 0x8, 0x02E773E8, 0x0B)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h1xy = new MemoryWatcherList() {
				(vars.H1_xpos = new MemoryWatcher<float>(new DeepPointer(0x03FB20D0, 0x8, 0x2D73144)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_ypos = new MemoryWatcher<float>(new DeepPointer(0x03FB20D0, 0x8, 0x2D73148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h1death = new MemoryWatcherList(){
				(vars.H1_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03FB20D0, 0x8, 0x2B611B7)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			//scan for 00 00 80 3F 00 00 80 3F 00 00 80 3F 02 00 00 00 FF FF 00 during cryo cs. Last 7 values are these, in order.
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x03FB20D0, 0x8, 0x2E7F878, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x03FB20D0, 0x8, 0x2E7F878, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03FB20D0, 0x8, 0x2E7F878, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2 = new MemoryWatcherList() {
				(vars.H2_tickcounter = new MemoryWatcher<uint>(new DeepPointer(0x03FB20D0, 0x28, 0x1776D04)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_cutsceneflag = new MemoryWatcher<byte>(new DeepPointer(0x03FB20D0, 0x28, 0x14CFAE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_CSind = new MemoryWatcher<byte>(new DeepPointer(0x03FB20D0, 0x28, 0x01D37C20, 0x38, 0x78, 0x1E8, 0xE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03FB20D0, 0x28, 0x01520498, -0x92E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_letterbox = new MemoryWatcher<float>(new DeepPointer(0x03FB20D0, 0x28, 0x01520498, -0x938)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_graphics = new MemoryWatcher<byte>(new DeepPointer(0x03FB20D0, 0x28, 0xCCF280)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) //scan for FF FF FF FF 2A 0A 00 0D on outskirts. Should be around here somewhere
			};
			
			vars.watchers_h2bsp = new MemoryWatcherList() {
				(vars.H2_bspstate = new MemoryWatcher<byte>(new DeepPointer(0x03FB20D0, 0x28, 0xCACD74)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2xy = new MemoryWatcherList() {
				(vars.H2_xpos = new MemoryWatcher<float>(new DeepPointer(0x03FB20D0, 0x28, 0xD5A148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_ypos = new MemoryWatcher<float>(new DeepPointer(0x03FB20D0, 0x28, 0xD5A14C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2IL = new MemoryWatcherList() {
				(vars.H2_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03FB20D0, 0x28, 0x147D9F0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2death = new MemoryWatcherList(){
				(vars.H2_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03FB20D0, 0x28, 0x00D5A5A0, -0xEF)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_h3 = new MemoryWatcherList() {
				(vars.H3_theatertime = new MemoryWatcher<uint>(new DeepPointer(0x03FB20D0, 0x48, 0x1EF6168)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
				//(vars.H3_validtimeflag = new MemoryWatcher<byte>(new DeepPointer(0x038CF520, 0x48, 0xD64296)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) //not using anymore
			};
			
			vars.watchers_h3bsp = new MemoryWatcherList() {
				(vars.H3_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03FB20D0, 0x48, 0x0099FC20, 0x2C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3IL = new MemoryWatcherList() {
				(vars.H3_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03FB20D0, 0x48, 0x9AD6A0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3death = new MemoryWatcherList(){
				(vars.H3_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03FB20D0, 0x48, 0x1d8dec8, 0x1073D)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H3_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hr = new MemoryWatcherList() {
				(vars.HR_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03FB20D0, 0xC8, 0x023CC768, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03FB20D0, 0xC8, 0x00EF2010, 0x12E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrbsp = new MemoryWatcherList() {
				(vars.HR_bspstate = new MemoryWatcher<uint>(new DeepPointer(0x03FB20D0, 0xC8, 0x3719E24)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrdeath = new MemoryWatcherList(){
				(vars.HR_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03FB20D0, 0xC8, 0x00EEF330, 0xEF2010)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_odst = new MemoryWatcherList() {
				(vars.odst_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03FB20D0, 0xA8, 0xA11C20)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
				
			};
			
			vars.watchers_odstbsp = new MemoryWatcherList() {
				(vars.odst_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03FB20D0, 0xA8, 0x2F9FD5C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			
			vars.watchers_odstdeath = new MemoryWatcherList(){
				(vars.odst_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03FB20D0, 0xA8, 0x00F3EB8C, -0x913)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.odst_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4 = new MemoryWatcherList() {
				(vars.H4_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03FB20D0, 0x68, 0x0267C478, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H4_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03FB20D0, 0x68, 0x29A383E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4bsp = new MemoryWatcherList() {
				(vars.H4_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03FB20D0, 0x68, 0x25DC188)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
	...
	} else if (modules.First().ToString() == "MCC-Win64-Shipping-WinStore.exe" || modules.First().ToString() == "MCCWinStore-Win64-Shipping.exe")
	{
		...
		if (version == "1.2904.0.0")
		{
			...
			vars.watchers_slow = new MemoryWatcherList() {
				...
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x03E1F540, 0xA8, 0xABD8E3), 4)), 
			...
			vars.watchers_h1 = new MemoryWatcherList() {
				...
				(vars.H1_tickcounter = new MemoryWatcher<uint>(new DeepPointer(0x03E1F540, 0x8, 0x2B88848)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	//take the one near camera angle that flicks to FF FF FF FF on mission restart plz burnt :)
			...
			vars.watchers_h3IL = new MemoryWatcherList() {
				(vars.H3_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E1F540, 0x48, 0x9AD720)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			...
			vars.watchers_hr = new MemoryWatcherList() {
				(vars.HR_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03E1F540, 0xC8, 0x023CC768, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03E1F540, 0xC8, 0x00EF2010, 0x12E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			...
			vars.watchers_odst = new MemoryWatcherList() {
				(vars.odst_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E1F540, 0xA8, 0xA11C20)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			...
			vars.watchers_h4 = new MemoryWatcherList() {
				...
				(vars.H4_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03E1F540, 0x68, 0x29A383E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
		...
		} else if (version == "1.2862.0.0")
		{
			...
			vars.watchers_slow = new MemoryWatcherList() {
				(vars.gameindicator = new MemoryWatcher<byte>(new DeepPointer(0x03E1FE68, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //scan for 8B 4B 18 ** ** ** ** **    48 8B 5C 24 30  89 07 nonwriteable, check what 89 07 writes to
				(vars.H2_levelname = new StringWatcher(new DeepPointer(0x03E1F540, 0x28, 0xD4ABF8), 3)),
				(vars.H3_levelname = new StringWatcher(new DeepPointer(0x03E1F540, 0x48, 0x1E092E8), 3)), 
				(vars.HR_levelname = new StringWatcher(new DeepPointer(0x03E1F540, 0xC8, 0x290BDA7), 3)),
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x03E1F540, 0xA8, 0xABD8E3), 4)), 
			...
			//scan for 00 00 80 3F 00 00 80 3F 00 00 80 3F 02 00 00 00 FF FF 00 during cryo cs. Last 7 values are these, in order.
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x03E1F540, 0x8, 0x2E7F878, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x03E1F540, 0x8, 0x2E7F878, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03E1F540, 0x8, 0x2E7F878, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
		...
		{
			vars.watchers_fast = new MemoryWatcherList() {
				(vars.menuindicator = new MemoryWatcher<byte>(new DeepPointer(0x3D1E7A9)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //behaviour changed to 07 and 0B, instead of 07 and 0C
				(vars.stateindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E08BE5)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_slow = new MemoryWatcherList() {
				(vars.gameindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E55368, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //scan for 8B 4B 18 ** ** ** ** **    48 8B 5C 24 30  89 07 nonwriteable, check what 89 07 writes to
				(vars.H2_levelname = new StringWatcher(new DeepPointer(0x03E54A40, 0x28, 0xD4ABF8), 3)),
				(vars.H3_levelname = new StringWatcher(new DeepPointer(0x03E54A40, 0x48, 0x1E092E8), 3)), 
				(vars.HR_levelname = new StringWatcher(new DeepPointer(0x03E54A40, 0xC8, 0x290BDA7), 3)),
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x03E54A40, 0xA8, 0xABD8E3), 4)), 
				(vars.ODST_levelnameBad2 = new StringWatcher(new DeepPointer(0x03E54A40, 0xA8, 0x20872f5), 4)), 
				
				(vars.H4_levelname = new StringWatcher(new DeepPointer(0x03E54A40, 0x68, 0x29A3743), 3))
			};
			...
			vars.watchers_h1xy = new MemoryWatcherList() {
				(vars.H1_xpos = new MemoryWatcher<float>(new DeepPointer(0x03E54A40, 0x8, 0x2D73144)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_ypos = new MemoryWatcher<float>(new DeepPointer(0x03E54A40, 0x8, 0x2D73148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h1death = new MemoryWatcherList(){
				(vars.H1_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54A40, 0x8, 0x2B611B7)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			//scan for 00 00 80 3F 00 00 80 3F 00 00 80 3F 02 00 00 00 FF FF 00 during cryo cs. Last 7 values are these, in order.
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0x8, 0x2E7F878, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x03E54A40, 0x8, 0x2E7F878, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03E54A40, 0x8, 0x2E7F878, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2 = new MemoryWatcherList() {
				(vars.H2_tickcounter = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0x28, 0x1776D04)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_cutsceneflag = new MemoryWatcher<byte>(new DeepPointer(0x03E54A40, 0x28, 0x14CFAE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_CSind = new MemoryWatcher<byte>(new DeepPointer(0x03E54A40, 0x28, 0x01D37C20, 0x38, 0x78, 0x1E8, 0xE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03E54A40, 0x28, 0x01520498, -0x92E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_letterbox = new MemoryWatcher<float>(new DeepPointer(0x03E54A40, 0x28, 0x01520498, -0x938)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_graphics = new MemoryWatcher<byte>(new DeepPointer(0x03E54A40, 0x28, 0xCCF280)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})			
			};
			
			vars.watchers_h2bsp = new MemoryWatcherList() {
				(vars.H2_bspstate = new MemoryWatcher<byte>(new DeepPointer(0x03E54A40, 0x28, 0xCACD74)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2xy = new MemoryWatcherList() {
				(vars.H2_xpos = new MemoryWatcher<float>(new DeepPointer(0x03E54A40, 0x28, 0xD5A148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_ypos = new MemoryWatcher<float>(new DeepPointer(0x03E54A40, 0x28, 0xD5A14C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2IL = new MemoryWatcherList() {
				(vars.H2_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0x28, 0x147D9F0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2death = new MemoryWatcherList(){
				(vars.H2_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54A40, 0x28, 0x00D5A5A0, -0xEF)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_h3 = new MemoryWatcherList() {
				(vars.H3_theatertime = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0x48, 0x1EF61E8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
				//(vars.H3_validtimeflag = new MemoryWatcher<byte>(new DeepPointer(0x038CF520, 0x48, 0xD64296)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) //not using anymore
			};
			
			vars.watchers_h3bsp = new MemoryWatcherList() {
				(vars.H3_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03E54A40, 0x48, 0x99FCA0, 0x2C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3IL = new MemoryWatcherList() {
				(vars.H3_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0x48, 0x9AD720)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3death = new MemoryWatcherList(){
				(vars.H3_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54A40, 0x48, 0x1D8DF48, 0x1073D)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H3_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hr = new MemoryWatcherList() {
				(vars.HR_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03E54A40, 0xC8, 0x023CC768, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03E54A40, 0xC8, 0x00EF2010, 0x12E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrbsp = new MemoryWatcherList() {
				(vars.HR_bspstate = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0xC8, 0x3719E24)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrdeath = new MemoryWatcherList(){
				(vars.HR_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54A40, 0xC8, 0x00EEF330, 0xEF2010)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_odst = new MemoryWatcherList() {
				(vars.odst_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0xA8, 0xA11C20)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
				
			};
			
			vars.watchers_odstbsp = new MemoryWatcherList() {
				(vars.odst_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03E54A40, 0xA8, 0x2F9FD5C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			
			vars.watchers_odstdeath = new MemoryWatcherList(){
				(vars.odst_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54A40, 0xA8, 0x00F3EB8C, -0x913)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.odst_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4 = new MemoryWatcherList() {
				(vars.H4_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03E54A40, 0x68, 0x0267C478, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H4_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03E54A40, 0x68, 0x29A383E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4bsp = new MemoryWatcherList() {
				(vars.H4_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03E54A40, 0x68, 0x25DC188)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
		...
		{
			vars.watchers_fast = new MemoryWatcherList() {
				(vars.menuindicator = new MemoryWatcher<byte>(new DeepPointer(0x3D1E729)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //behaviour changed to 07 and 0B, instead of 07 and 0C
				(vars.stateindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E08BC5)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_slow = new MemoryWatcherList() {
				(vars.gameindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E55260, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //scan for 8B 4B 18 ** ** ** ** **    48 8B 5C 24 30  89 07 nonwriteable, check what 89 07 writes to
				(vars.H2_levelname = new StringWatcher(new DeepPointer(0x03E54940, 0x28, 0xD4ABF8), 3)),
				(vars.H3_levelname = new StringWatcher(new DeepPointer(0x03E54940, 0x48, 0x1E092E8), 3)), 
				(vars.HR_levelname = new StringWatcher(new DeepPointer(0x03E54940, 0xC8, 0x290BDA7), 3)),
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x03E54940, 0xA8, 0xABD8E3), 4)), 
				(vars.ODST_levelnameBad2 = new StringWatcher(new DeepPointer(0x03E54940, 0xA8, 0x20872f5), 4)), 
				
				(vars.H4_levelname = new StringWatcher(new DeepPointer(0x03E54940, 0x68, 0x29A3743), 3))
			};
			...
			vars.watchers_h1 = new MemoryWatcherList() {
				...
				(vars.H1_cutsceneskip = new MemoryWatcher<bool>(new DeepPointer(0x03E54940, 0x8, 0x02E773D8, 0x0B)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h1xy = new MemoryWatcherList() {
				(vars.H1_xpos = new MemoryWatcher<float>(new DeepPointer(0x03E54940, 0x8, 0x2D73144)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_ypos = new MemoryWatcher<float>(new DeepPointer(0x03E54940, 0x8, 0x2D73148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h1death = new MemoryWatcherList(){
				(vars.H1_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54940, 0x8, 0x2B611B7)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			//scan for 00 00 80 3F 00 00 80 3F 00 00 80 3F 02 00 00 00 FF FF 00 during cryo cs. Last 7 values are these, in order.
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x03E54940, 0x8, 0x2E7F868, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x03E54940, 0x8, 0x2E7F868, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03E54940, 0x8, 0x2E7F868, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2 = new MemoryWatcherList() {
				(vars.H2_tickcounter = new MemoryWatcher<uint>(new DeepPointer(0x03E54940, 0x28, 0x1776D04)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_cutsceneflag = new MemoryWatcher<byte>(new DeepPointer(0x03E54940, 0x28, 0x14CFAE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_CSind = new MemoryWatcher<byte>(new DeepPointer(0x03E54940, 0x28, 0x01D37C20, 0x38, 0x78, 0x1E8, 0xE8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03E54940, 0x28, 0x01520498, -0x92E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_letterbox = new MemoryWatcher<float>(new DeepPointer(0x03E54940, 0x28, 0x01520498, -0x938)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_graphics = new MemoryWatcher<byte>(new DeepPointer(0x03E54940, 0x28, 0xCCF280)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2bsp = new MemoryWatcherList() {
				(vars.H2_bspstate = new MemoryWatcher<byte>(new DeepPointer(0x03E54940, 0x28, 0xCACD74)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2xy = new MemoryWatcherList() {
				(vars.H2_xpos = new MemoryWatcher<float>(new DeepPointer(0x03E54940, 0x28, 0xD5A148)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_ypos = new MemoryWatcher<float>(new DeepPointer(0x03E54940, 0x28, 0xD5A14C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2IL = new MemoryWatcherList() {
				(vars.H2_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E54940, 0x28, 0x147D9F0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h2death = new MemoryWatcherList(){
				(vars.H2_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54940, 0x28, 0x00D5A5A0, -0xEF)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H2_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			
			vars.watchers_h3 = new MemoryWatcherList() {
				(vars.H3_theatertime = new MemoryWatcher<uint>(new DeepPointer(0x03E54940, 0x48, 0x1EF61E8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
				//(vars.H3_validtimeflag = new MemoryWatcher<byte>(new DeepPointer(0x038CF520, 0x48, 0xD64296)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) //not using anymore
			};
			
			vars.watchers_h3bsp = new MemoryWatcherList() {
				(vars.H3_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03E54940, 0x48, 0x99FCA0, 0x2C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3IL = new MemoryWatcherList() {
				(vars.H3_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E54940, 0x48, 0x9AD720)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3death = new MemoryWatcherList(){
				(vars.H3_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54940, 0x48, 0x1D8DF48, 0x1073D)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H3_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hr = new MemoryWatcherList() {
				(vars.HR_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03E54940, 0xC8, 0x023CC768, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03E54940, 0xC8, 0x00EF2010, 0x12E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrbsp = new MemoryWatcherList() {
				(vars.HR_bspstate = new MemoryWatcher<uint>(new DeepPointer(0x03E54940, 0xC8, 0x3719E24)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_hrdeath = new MemoryWatcherList(){
				(vars.HR_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54940, 0xC8, 0x00EEF330, 0xEF2010)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.HR_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_odst = new MemoryWatcherList() {
				(vars.odst_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E54940, 0xA8, 0xA11C20)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
				
			};
			
			vars.watchers_odstbsp = new MemoryWatcherList() {
				(vars.odst_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03E54940, 0xA8, 0x2F9FD5C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			
			vars.watchers_odstdeath = new MemoryWatcherList(){
				(vars.odst_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54940, 0xA8, 0x00F3EB8C, -0x913)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.odst_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4 = new MemoryWatcherList() {
				(vars.H4_IGT = new MemoryWatcher<uint> (new DeepPointer(0x03E54940, 0x68, 0x0267C478, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H4_validtimeflag = new MemoryWatcher<byte> (new DeepPointer(0x03E54940, 0x68, 0x29A383E)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			
			vars.watchers_h4bsp = new MemoryWatcherList() {
				(vars.H4_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03E54940, 0x68, 0x25DC188)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
		...
		} else if (version == "1.2819.0.0")
		{
			...
			vars.watchers_slow = new MemoryWatcherList() {
				(vars.gameindicator = new MemoryWatcher<byte>(new DeepPointer(0x3E55360, 0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}), //scan for 8B 4B 18 ** ** ** ** **    48 8B 5C 24 30  89 07 nonwriteable, check what 89 07 writes to
				(vars.H2_levelname = new StringWatcher(new DeepPointer(0x03E54A40, 0x28, 0xD4ABF8), 3)),
				(vars.H3_levelname = new StringWatcher(new DeepPointer(0x03E54A40, 0x48, 0x1E09268), 3)), 
				(vars.HR_levelname = new StringWatcher(new DeepPointer(0x03E54A40, 0xC8, 0x290BDA7), 3)),
				(vars.ODST_levelnameBad = new StringWatcher(new DeepPointer(0x03E54A40, 0xA8, 0xABD8E3), 4)), 
				(vars.ODST_levelnameBad2 = new StringWatcher(new DeepPointer(0x03E54A40, 0xA8, 0x20872f5), 4)), 
			...
			vars.watchers_h3 = new MemoryWatcherList() {
				(vars.H3_theatertime = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0x48, 0x1EF6168)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
				//(vars.H3_validtimeflag = new MemoryWatcher<byte>(new DeepPointer(0x038CF520, 0x48, 0xD64296)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) //not using anymore
			};
			
			vars.watchers_h3bsp = new MemoryWatcherList() {
				(vars.H3_bspstate = new MemoryWatcher<ulong>(new DeepPointer(0x03E54A40, 0x48, 0x0099FC20, 0x2C)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3IL = new MemoryWatcherList() {
				(vars.H3_IGT = new MemoryWatcher<uint>(new DeepPointer(0x03E54A40, 0x48, 0x9AD6A0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}) 
			};
			
			vars.watchers_h3death = new MemoryWatcherList(){
				(vars.H3_deathflag = new MemoryWatcher<bool>(new DeepPointer(0x03E54A40, 0x48, 0x1d8dec8, 0x1073D)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H3_revertcount = new MemoryWatcher<byte>(new DeepPointer(0x0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
		...
		} else if (version == "1.2645.0.0")
		{
			...
			vars.watchers_h1 = new MemoryWatcherList() {
				...
				(vars.H1_cinematic = new MemoryWatcher<bool>(new DeepPointer(0x03A23830, 0x8, 0x2af89b8, 0x0A)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
			...
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x03A23830, 0x8, 0x2B88E58, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x03A23830, 0x8, 0x2B88E58, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x03A23830, 0x8, 0x2B88E58, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			...
			vars.watchers_h2 = new MemoryWatcherList() {
				...
				(vars.H2_graphics = new MemoryWatcher<byte>(new DeepPointer(0x03A23830, 0x28, 0xCC74A8)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
		...
		} else if (version == "1.2448.0.0")
		{
			...
			vars.watchers_h1fade = new MemoryWatcherList(){
				(vars.H1_fadetick = new MemoryWatcher<uint>(new DeepPointer(0x038C7940, 0x8, 0x2B81CE8, 0x3C0)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),	
				(vars.H1_fadelength = new MemoryWatcher<ushort>(new DeepPointer(0x038C7940, 0x8, 0x2B81CE8, 0x3C4)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull}),
				(vars.H1_fadebyte = new MemoryWatcher<byte>(new DeepPointer(0x038C7940, 0x8, 0x2B81CE8, 0x3C6)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
			...
			vars.watchers_h2 = new MemoryWatcherList() {
				...
				(vars.H2_graphics = new MemoryWatcher<byte>(new DeepPointer(0x038C7940, 0x28, 0xCFB918)) { FailAction = MemoryWatcher.ReadFailAction.SetZeroOrNull})
			};
...
{ 
	...
	settings.Add("sqsplit", true, "Split when save & quitting and loading a new level. Useful for categories like Hunter%. Only works for Halo CE");
...
update {
	...
	//var guh = modules.First().FileName;
	
	//print ("test " + FileVersionInfo.GetVersionInfo(guh)); 
	...
	if (vars.menuindicator.Current == 7)
	{
		...
		switch (test)
		{
			...
			if (settings["Loopmode"] && vars.H1_levelname.Current == vars.startedlevel && vars.loopsplit == false && vars.H1_tickcounter.Current < 1500)
			{
				...
				{
					case "a10":
					if (vars.H1_tickcounter.Current > 280 && vars.H1_cinematic.Current == false && vars.H1_cinematic.Old == true)
					{
						vars.dirtybsps_byte.Clear();
						vars.loopsplit = true;
						return true;
			...
			{				
				...
				switch (checklevel)
				{
					...
					{
						if (vars.H1_tickcounter.Current >= (vars.H1_fadetick.Current + 14) && vars.H1_tickcounter.Old < (vars.H1_fadetick.Current + 14))
						{
							vars.dirtybsps_byte.Clear();
							vars.loopsplit = false;
							return true;
	...
	if (vars.multigamepause)
	{
		...
		if (vars.menuindicator.Current == 7) 
		{
			...
			switch (test)
			{
				...
				case 0:
				if (vars.H1_levelname.Current == "a10" && vars.H1_tickcounter.Current > 280 && vars.H1_cinematic.Current == false && vars.H1_cinematic.Old == true)
				{	
		...
		if (vars.loading == false ) //if not currently loading, determine whether we need to be
		{
			if (vars.menuindicator.Current == 7) //between level loads.
			{
				...
				switch(H2_checklevel)
				{
					...
					{
						vars.watchers_h2bsp.UpdateAll(game);
						if (vars.H2_levelname.Current == "04b" && vars.H2_bspstate.Current == 5)
						{
							vars.lastinternal = true;
							return false;
						}
						else if (vars.H2_levelname.Current == "05b" && vars.H2_bspstate.Current == 2)
						{
							vars.lastinternal = true;
							return false;
						}
			...
			else if (vars.stateindicator.Current == 44 || vars.stateindicator.Current == 57) //main menu to level loads.
			{
				vars.loading = true;
			}
		}
		else	//if currently loading, determine whether we need not be
		{
			if (vars.menuindicator.Current == 7) //between level loads.
			{
				...
				switch(H2_checklevel)
				{
					...
					if (vars.H2_fadebyte.Current == 0 && vars.H2_fadebyte.Old == 1 && vars.stateindicator.Current != 44)
					{
						vars.loading = false;
						vars.lastinternal = false;
					...
					{
						if (vars.H2_fadebyte.Current == 1 && vars.H2_tickcounter.Current < 85 && vars.H2_tickcounter.Current > 75)
						{
							vars.watchers_h2bsp.UpdateAll(game);
